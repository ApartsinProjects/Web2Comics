...
const OUT_PNG = path.join(OUT_DIR, 'my-collection-collage.png');
const OUT_JSON = path.join(OUT_DIR, 'my-collection-collage.json');
...
const PROMPT = [
  'Create a premium illustration for a "My Collection" comic gallery button in a Chrome extension UI.',
  'Show many comic cards in a stylish collage/pile composition, dynamic and playful.',
  'Use clean modern digital illustration style, high contrast, rich colors, crisp edges.',
  'No text, no letters, no logos, no watermark.',
  'Center-weighted composition that works when cropped into a rounded square icon.',
  'Visual tone: creative, organized collection, energetic but not noisy.'
].join(' ');
